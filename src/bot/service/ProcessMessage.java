...
public class ProcessMessage {
	...
	public final static String START_REGEX = "(-s (lundi|mardi|mercredi|jeudi|vendredi|samedi|dimanche) [0-9]{1,2}:[0-9]{2})|((lundi|mardi|mercredi|jeudi|vendredi|samedi|dimanche) [0-9]{1,2}:[0-9]{2} [0-9]+)";
